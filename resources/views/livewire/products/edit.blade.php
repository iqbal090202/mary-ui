...
new class extends Component {
    ...
    public function save(): void
    {
        ...
        $this->success('Product updated wth success', redirectTo: '/products');
    }
...
<div>
    <x-header title="Update {{ $form->product->product_name }}" separator />
        ...
        <div class="grid-cols-5 lg:grid">
            ...
            <div class="grid col-span-3 gap-3">
                <x-file label="Photo" wire:model="form.product_photo" accept="image/png, image/jpeg" crop-after-change>
                    <img src="{{ $form->product->photo ?? '/empty-user.jpg' }}" class="h-40 rounded-lg"/>
                </x-file>
            ...
            <div class="grid col-span-3 gap-3">
                ...
                @foreach ($form->variants as $index => $variant)
                    ...
                    <div class="grid gap-3 mb-3">
                        ...
                        <x-input label="Price" wire:model.lazy="form.variants.{{$index}}.price"/>
